# An extension of a collection of `.gitignore` templates

This is an extension of GitHub’s collection of [`.gitignore`][man] file templates.
...
- [`Global`](https://github.com/hlarsonnn/gitignore-extension/tree/main/Global) contains templates for various editors, tools and
  ...
  them permanently.
- [`community`](https://github.com/hlarsonnn/gitignore-extension/tree/main/community) contains specialized templates for other popular
  languages, tools and project, which don't currently belong in the mainstream
  templates. These should be added to your project-specific templates when you
  decide to adopt the framework or tool.
- [`Extension`](https://github.com/hlarsonnn/gitignore-extension/tree/main/Extension) contains extra `.gitignore` template files of languages which are not implemented into GitHub Git Ignores as of April 2025.
...
[CC0-1.0](https://github.com/hlarsonnn/gitignore-extension/tree/main/.github/LICENSE).
